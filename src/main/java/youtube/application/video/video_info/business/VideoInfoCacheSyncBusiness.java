package youtube.application.video.video_info.business;
...
import youtube.application.video.video_info.implement.VideoInfoCacheUpdater;
...
@Service
public class VideoInfoCacheSyncBusiness {

    private final VideoInfoCacheUpdater videoInfoCacheUpdater;
    private final CacheManager cacheManager;

    public VideoInfoCacheSyncBusiness(final VideoInfoCacheUpdater videoInfoCacheUpdater,
