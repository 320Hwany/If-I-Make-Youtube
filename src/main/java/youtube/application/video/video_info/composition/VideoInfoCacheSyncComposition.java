package youtube.application.video.video_info.composition;
...
import youtube.application.video.video_info.VideoInfoCacheUpdater;
...
@Service
public class VideoInfoCacheSyncComposition {

    private final VideoInfoCacheUpdater videoInfoCacheUpdater;
    private final CacheManager cacheManager;

    public VideoInfoCacheSyncComposition(final VideoInfoCacheUpdater videoInfoCacheUpdater,
