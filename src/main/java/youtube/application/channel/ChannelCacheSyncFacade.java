...
import youtube.application.channel.command.ChannelSubscriptionCountUpdater;
...
@Service
public class ChannelCacheSyncFacade {

    private final ChannelSubscriptionCountUpdater channelSubscriptionCountUpdater;
    private final CacheManager cacheManager;

    public ChannelCacheSyncFacade(final ChannelSubscriptionCountUpdater channelSubscriptionCountUpdater,
                                  final CacheManager cacheManager) {
        this.channelSubscriptionCountUpdater = channelSubscriptionCountUpdater;
        ...
        CompletableFuture<?>[] futures = cacheMap.entrySet()
                ...
                .map(entry ->
                        CompletableFuture.runAsync(
                                () -> channelSubscriptionCountUpdater.command(entry.getKey(), entry.getValue())
                        )
                )
