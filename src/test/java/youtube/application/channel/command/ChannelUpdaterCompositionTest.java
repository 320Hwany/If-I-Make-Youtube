...
class ChannelUpdaterCompositionTest extends ServiceTest {

    @Autowired
    private ChannelUpdaterComposition channelUpdaterComposition;
    ...
    void channelNameUpdate() {
        ...
        // when
        channelUpdaterComposition.updateChannelName(member.getId(), channelNameUpdate);
    ...
    void channelDescriptionUpdate() {
        ...
        // when
        channelUpdaterComposition.updateChannelDescription(member.getId(), channelDescriptionUpdate);
        Channel psChannel = channelRepository.getByMemberId(member.getId());
