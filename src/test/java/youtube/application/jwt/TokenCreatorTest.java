...
class TokenCreatorTest extends ServiceTest {
    ...
    void createAccessToken() throws JsonProcessingException {
        ...
        // when
        String accessToken = tokenCreator.createAccessToken(memberSession, expired);
    ...
    void createRefreshToken() {
        ...
        // when
        String refreshToken = tokenCreator.createRefreshToken(memberId, expired);
