...
class MemberLoginBusinessTest extends ServiceTest {

    @Autowired
    private MemberLoginBusiness memberLoginBusiness;
    ...
    void loginFailNotFound() {
        ...
        // expected
        assertThatThrownBy(() -> memberLoginBusiness.login(dto, response))
    ...
    void loginSuccess() {
        ...
        // when
        memberLoginBusiness.login(dto, response);
