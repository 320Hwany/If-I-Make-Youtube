...
import static youtube.util.TestConstant.TEST_PASSWORD;

@AcceptanceTest
class CommandMemberSaveTest {

    @Autowired
    private CommandMemberSave commandMemberSave;
    ...
    void saveFail() {
        ...
        // expected
        assertThatThrownBy(() -> commandMemberSave.command(dto))
