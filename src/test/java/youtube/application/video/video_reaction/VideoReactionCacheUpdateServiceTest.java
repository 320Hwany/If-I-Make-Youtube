...
import youtube.application.video.video_reaction.VideoReactionCacheUpdateService;
...
class VideoReactionCacheUpdateServiceTest extends ServiceTest {

    @Autowired
    protected VideoReactionCacheUpdateService videoReactionCacheUpdateService;
