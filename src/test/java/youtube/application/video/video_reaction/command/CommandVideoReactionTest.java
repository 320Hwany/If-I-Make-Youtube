...
import youtube.application.video.video_reaction.command.CommandVideoReaction;
...
class CommandVideoReactionTest extends ServiceTest {

    @Autowired
    private CommandVideoReaction commandVideoReaction;
    ...
    void commandVideoReaction() {
        ...
        // when
        commandVideoReaction.command(member.getId(), dto);
