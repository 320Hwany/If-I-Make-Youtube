...
class CommandVideoWatchLaterDeleteTest extends ServiceTest {

    @Autowired
    private CommandVideoWatchLaterDelete commandVideoWatchLaterDelete;
    ...
    void commandVideoWatchLaterDeleteFail() {
        ...
        // when
        assertThatThrownBy(() -> commandVideoWatchLaterDelete.command(memberId, videoInfoId))
    ...
    void commandVideoWatchLaterDeleteSuccess() {
        ...
        // when
        commandVideoWatchLaterDelete.command(memberId, videoInfoId);
