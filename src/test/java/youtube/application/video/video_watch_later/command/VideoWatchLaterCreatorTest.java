...
import youtube.application.video.video_watch_later.VideoWatchLaterCreator;
...
class VideoWatchLaterCreatorTest extends ServiceTest {

    @Autowired
    private VideoWatchLaterCreator videoWatchLaterCreator;
    ...
    void commandVideoWatchLaterSaveFail() {
        ...
        // when
        videoWatchLaterCreator.command(memberId, videoInfoId);
